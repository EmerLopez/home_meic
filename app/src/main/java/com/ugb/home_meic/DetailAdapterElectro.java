...
public class DetailAdapterElectro extends RecyclerView.Adapter<MyViewHolder>{

    private Context context;
    private List<DataClass> dataList;
    public DetailAdapterElectro(Context context, List<DataClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, detailElectroActivity.class);
...
class MyViewHolderAdapterE extends RecyclerView.ViewHolder{
    ImageView recImage;
    TextView recProducto, recDesc, recPrecio, recMarca, recDisp, recEspecs;
    CardView recCard;
    public MyViewHolderAdapterE(@NonNull View itemView) {
        super(itemView);
