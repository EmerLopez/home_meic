    ...
    public String administrar_agenda(String id, String rev, String idUnico, String nom, String dir, String tel, String em, String urlfoto, String accion){
        try{
            ...
            if(accion.equals("nuevo")){
                db.execSQL("INSERT INTO agenda(id, rev, idUnico, nombre,direccion,telefono,email, urlfoto) VALUES('"+id+"', '"+rev+"','"+idUnico+"', '"+nom+"','"+dir+"','"+tel+"','"+em+"','"+urlfoto+"')");
            } else if (accion.equals("modificar")) {
                db.execSQL("UPDATE agenda SET id = '"+id+"',rev= '"+rev+"', nombre='"+nom+"', direccion='"+dir+"', telefono='"+tel+"', email='"+em+"', urlfoto='"+urlfoto+"' WHERE idUnico='"+idUnico+"'");
