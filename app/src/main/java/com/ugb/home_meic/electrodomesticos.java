...
public class electrodomesticos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(electrodomesticos.this, mainElectro.class);
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Categoria Electrodomesticos");
                ...
                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(electrodomesticos.this, "Deleted", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), mainElectro.class));
                        finish();
                    }
                });
            }
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(electrodomesticos.this, updateElectro.class)
