...
public class updateElectro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_electro);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(updateElectro.this, electrodomesticos.class);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(updateElectro.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        if (bundle != null){
            Glide.with(updateElectro.this).load(bundle.getString("Image")).into(updateImage);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Categoria Electrodomesticos").child(key);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveData();
                Intent intent = new Intent(updateElectro.this,mainElectro.class);
                startActivity(intent);
            }
        });
    }
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(updateElectro.this);
        ...
        databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    reference.delete();
                    Toast.makeText(updateElectro.this, "Updated", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updateElectro.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}