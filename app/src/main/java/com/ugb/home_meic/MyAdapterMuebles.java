...
public class MyAdapterMuebles extends RecyclerView.Adapter<MyViewHolder>{

    private Context context;
    private List<DataClass> dataList;
    public MyAdapterMuebles(Context context, List<DataClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, muebles.class);
...
class MyViewHolderMuebles extends RecyclerView.ViewHolder{
    ImageView recImage;
    TextView recProducto, recDesc, recPrecio, recMarca, recDisp, recEspecs;
    CardView recCard;
    public MyViewHolderMuebles(@NonNull View itemView) {
        super(itemView);
