...
public class uploadMuebles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_muebles);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(uploadMuebles.this, mainMuebles.class);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(uploadMuebles.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    public void saveData(){
        ...
        builder = new AlertDialog.Builder(uploadMuebles.this);
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Categoria Muebles").child(producto)
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(uploadMuebles.this, "Saved", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(uploadMuebles.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
