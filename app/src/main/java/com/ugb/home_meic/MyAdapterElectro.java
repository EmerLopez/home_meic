...
public class MyAdapterElectro extends RecyclerView.Adapter<MyViewHolder>{
    private Context context;
    private List<DataClass> dataList;
    public MyAdapterElectro(Context context, List<DataClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, electrodomesticos.class);
...
class MyViewHolderElectro extends RecyclerView.ViewHolder{
    ImageView recImage;
    TextView recProducto, recDesc, recPrecio, recMarca, recDisp, recEspecs;
    CardView recCard;
    public MyViewHolderElectro(@NonNull View itemView) {
        super(itemView);
