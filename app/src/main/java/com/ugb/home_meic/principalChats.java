...
public class principalChats extends Activity {
    ImageView imgPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_chats);
        ...
        btnGuarder = findViewById(R.id.btnGuardarUsuario);
    ...
    private void guardarUsuario(){
        try{
            ...
            if( miToken!=null && miToken!="" ){
                usuarios user = new usuarios(nombre, "monicacampostrejo9@gmail.com", urlCompleteImg, urlCompleteImgFirestore, miToken);
                if(key!=null){
    ...
    void tomarFoto() {
        ...
        imgPhoto.setOnClickListener(v->{
            ...
            if (takePhotoIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (photoFile != null) {
                    try {
                        Uri photoURI = FileProvider.getUriForFile(principalChats.this, "com.ugb.miapp.fileprovider", photoFile);
