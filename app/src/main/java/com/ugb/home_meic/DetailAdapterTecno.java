...
public class DetailAdapterTecno extends RecyclerView.Adapter<MyViewHolder>{

    private Context context;
    private List<DataClass> dataList;
    public DetailAdapterTecno(Context context, List<DataClass> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, detailTecnoActivity.class);
...
class MyViewHolderAdapterT extends RecyclerView.ViewHolder{
    ImageView recImage;
    TextView recProducto, recDesc, recPrecio, recMarca, recDisp, recEspecs;
    CardView recCard;
    public MyViewHolderAdapterT(@NonNull View itemView) {
        super(itemView);
